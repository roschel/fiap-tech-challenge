            ...
            text(
                f'''
                        ...
                        VALUES 
                            ...
                            ('{product_5_id}', 'Coca-Cola', 'Refrescante e geladinha. Uma bebida assim refresca a vida. Você pode escolher entre Coca-Cola, Coca-Cola Zero, Sprite sem Açúcar, Fanta Guaraná e Fanta Laranja.', 7.90,true, false, '{datetime.utcnow()}', null, '{category_3_id}', '{user_4_id}', null),
                            ('{product_6_id}', 'Guaraná', 'Refrescante e geladinha. Uma bebida assim refresca a vida. Você pode escolher entre Coca-Cola, Coca-Cola Zero, Sprite sem Açúcar, Fanta Guaraná e Fanta Laranja', 7.90,true, false, '{datetime.utcnow()}', null, '{category_3_id}', '{user_1_id}', null),
                            ('{product_7_id}', 'Casquinha', 'A sobremesa que o Brasil todo adora. Uma casquinha supercrocante, com bebida láctea mista (sabor baunilha e chocolate) que vai bem a qualquer hora.', 5.50, true, false, '{datetime.utcnow()}', null, '{category_2_id}', '{user_2_id}', null),
                            ('{product_8_id}', 'Torta de maçã', 'Boa demais. Parece a receita lá de casa. Massa quentinha e crocante envolvendo deliciosos recheios de banana ou maçã com gostinho de doce caseiro', 10.9, true, false, '{datetime.utcnow()}', null, '{category_2_id}', '{user_3_id}', null)
                        '''
            )
        )
        session.commit()
